  ...
  <div class="body">
    ...
    <aside class="panel panel-left">
      ...
      <div class="panel-body">
        ...
        <p class="hint">
          Click any phrase to rank the vector space by cosine similarity.
        </p>
      </div>
    </aside>
...
<style>
  ...
  /* dotted grid on the vector space to evoke dimensionality */
  .panel-right {
  ...
  .phrase-item.is-target {
    background: var(--amber-glow);
    border-bottom-color: rgba(232, 197, 71, 0.18);
  }

  .phrase-item.is-target:hover {
